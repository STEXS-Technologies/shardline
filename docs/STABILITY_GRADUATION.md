...
| Bazel HTTP cache | Beta | broader platform evidence; pinned Bazel 8.7.0/9.2.0 client flows, Postgres-backed CAS/AC roundtrip, same-digest concurrency, AC/CAS isolation, interrupted PUT, and large objects have checked-in coverage |
