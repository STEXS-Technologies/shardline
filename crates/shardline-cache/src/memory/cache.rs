...
pub const LOADER_ORPHAN_TOTAL_TIMEOUT: Duration = Duration::from_secs(60);
...
/// (F-100).
pub const LOADER_ORPHAN_EXTENSION_CAP: u32 = 4;
...
pub(super) const LOADER_HEARTBEAT_INTERVAL: Duration = Duration::from_secs(5);
...
pub(super) const LOADER_ALIVE_GRACE: Duration = Duration::from_secs(10);
...
pub(super) const MAX_MEMORY_CACHE_BYTES: usize = 256 * 1024 * 1024;
...
pub struct MemoryReconstructionCache {
    ...
    pub(super) loading: Arc<Mutex<HashMap<ReconstructionCacheKey, LoadingEntry>>>,
}
