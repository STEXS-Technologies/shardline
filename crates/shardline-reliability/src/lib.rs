...
pub use persisted::{
    ...
    persisted_event_sequence, verify_persisted_event, verify_persisted_event_merkle_chain,
    verify_persisted_event_merkle_chain_with_sequences, verify_persisted_merkle_commit,
