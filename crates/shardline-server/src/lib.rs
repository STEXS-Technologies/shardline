...
pub(crate) mod oci_adapter {
    pub(crate) use shardline_oci_adapter::{
        ...
        new_upload_session_id, oci_blob_location, oci_manifest_location, oci_manifest_prefix,
        oci_tag_key, oci_tag_prefix, parse_reference, read_upload_session, touch_upload_session,
