...
#[cfg(test)]
pub fn live_upload_lock_count() -> usize {
...
pub const S3_XML_CONTENT_TYPE: &str = "application/xml";
...
pub struct S3ObjectContext<'ctx> {
    /// The bound capability this context was derived from.
    pub auth: &'ctx AuthorizedRepository,
...
/// key is invalid.
pub fn require_s3_object_context<'ctx>(
...
/// parser budget.
pub fn parse_s3_query(uri: &Uri) -> Result<QueryMap, S3Error> {
...
#[must_use]
pub fn has_sub_resource(query: &QueryMap) -> bool {
